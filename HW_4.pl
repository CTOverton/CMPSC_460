...
subsum(Set, Sum, Subset) :- subset(Set, Subset), sum(Subset, Sum).
...
expression(X) :- num(X).
expression(X) :- append(List1, [+|List2], X), num(List1), expression(List2).
expression(X) :- append(List1, [-|List2], X), num(List1), expression(List2).
expression(X) :- append(List1, [*|List2], X), num(List1), expression(List2).
expression(X) :- append(List1, [/|List2], X), num(List1), expression(List2).
expression(X) :- append(List1, ['('|List2], X), num(List1), expression(List2).
expression(X) :- append(List1, [')'|List2], X), num(List1), expression(List2).
expression(X) :- atomic(X).

% ----------------------------------------
% [ Example 7 ]

btree([])
btree([H|[L|R]]) :- atomic(H), btree(L), btree(R).
